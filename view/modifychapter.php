        ...
        <div class="form-group">
            <form class="well-lg form-horizontal" action="<?php aff('self');?>" method="post">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="numero" required="required" value="<?php echo
					$chapter->getNumero();?>">
				</div>
				<div class="form-group">
                ...
                <input type="submit" formnovalidate="formnovalidate" name="modif" value="Modifier le brouillon" class="btn btn-warning">
				<input type="submit" formnovalidate="formnovalidate" name="publi" value="Modifier et Publier" class="btn btn-success">
